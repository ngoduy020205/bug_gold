...
def buy():
    ...
    if game_id == '5': # Uchia Truyền Kỳ (Đã cập nhật IP & Port chuẩn, bỏ tham số app)
        base_url = "http://103.149.252.111:92/api.php/pf/sygame/pay_web/" 
    elif game_id == '4': # Học Viện Shinobi
